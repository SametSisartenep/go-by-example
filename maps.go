...
func main() {
	...
	// The builtin `len` returns the number of key/value pairs when called on a
	// map.
	...
	// The optional second return value when getting value from a map indicates if
	// the key was present in the map. This can be used to disambiguate between
